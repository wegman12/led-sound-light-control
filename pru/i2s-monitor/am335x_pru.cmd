/****************************************************************************/
/*  AM335x_PRU.cmd - PRU1 Linker Command File                               */
...
MEMORY
{
	...
	/* RAM */
	/* NOTE: For PRU1, the memory names are swapped compared to PRU0 */
	/* PRU1's local DRAM is at 0x00002000 (PRU_DMEM_1_0) */
	/* PRU0's DRAM is at 0x00000000 (PRU_DMEM_0_1) */

	PRU_DMEM_0_1	: org = 0x00000000 len = 0x00002000 CREGISTER=24 /* 8kB PRU0 Data RAM */
	PRU_DMEM_1_0	: org = 0x00002000 len = 0x00002000	CREGISTER=25 /* 8kB PRU1 Data RAM (LOCAL) */
...
/* PRU1 uses PRU_DMEM_1_0 as its local data memory */
SECTIONS {
